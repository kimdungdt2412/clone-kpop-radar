...
export default function Header() {
    ...
    useEffect(() => {
        isAboutPage ? document.body.style.background = "black" : document.body.style.background = "white"
    }, [isAboutPage])

    return (
        <header id="header" className={`block mx-auto z-[120] p-[13px] lg:py-[30px] lg:px-[32px] lg:pr-[15px] xl:pl-[60px] xl:pr-[25px] xl:pb-[10px] w-full max-w-[1920px] box-border z-120 lg:z-[100] fixed top-0 left-0 right-0 after:block after:clear-both after:content-[''] ${scrollPosition > 200 ? `xl:h-[80px] xl:pt-[20px] ${isAboutPage ? "bg-black" : "bg-white"}` : "xl:pt-[35px]"}`}>
