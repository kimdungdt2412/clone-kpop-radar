...
export default function DashboardHeader({ boardType = {} }) {
    ...
    return (
        <header id="header" className={`block bg-white z-[120] p-[13px] lg:py-[30px] lg:px-[32px] lg:pr-[15px] xl:pl-[60px] xl:pr-[25px] xl:pb-[10px] w-full max-w-[1920px] box-border z-120 lg:z-[100] fixed top-0 left-0 right-0 transition duration-300 after:block after:clear-both after:content-[''] ${scrollPosition > 200 ? "xl:h-[80px] xl:pt-[20px]" : "xl:pt-[35px]"}`}>
            <LogoComponent />
                            ...
                            <NavLink
                                className={({ isActive }) =>
                                    (isActive || (item.url === "/board" && ["/"].includes(location.pathname)))
                                        ? `block relative text-black text-[11px] leading-[11px] font-medium box-border px-0 py-[15px] lg:text-[17px] lg:leading-[17px] text-center lg:py-[25px] lg:px-[10px] xl:pl-[35px] xl:pr-[32px] ${scrollPosition > 200 ? "xl:py-[15px]" : "xl:pt-[24px] xl:pb-[30px]"}`
                                        : `block relative text-black/50 text-[11px] leading-[11px] font-medium box-border px-0 py-[15px] lg:text-[17px] lg:leading-[17px] text-center lg:py-[25px] lg:px-[10px] xl:pl-[35px] xl:pr-[32px] ${scrollPosition > 200 ? "xl:py-[15px]" : "xl:pt-[24px] xl:pb-[30px]"}`
                                }
